...
async def help_message(message: Message) -> None:
    await message.answer(
        ...
        "Если в базе есть проверенный фрагмент, ответ содержит значение, условия, документ, пункт, "
        "страницу и ссылку. Если текста пункта ещё нет, бот подбирает применимые документы и не "
